...
use crate::work::{HERO_PIECES, PIECES};
    ...
    view! {
        <main id="main">
            ...
            <section class="section faq" id="faq" aria-labelledby="faq-title">
                ...
                <p class="hint reveal">
                    "Short answers about Goldev, the stack, and how to work together."
                </p>
                <div class="faq-list">
                    {faq}
                </div>
            ...
            <section class="section contact-section" id="contact" aria-labelledby="contact-title">
                ...
                <p class="hint reveal">
                    "Projects, collaborations, or a quiet note — email is the fastest path."
                </p>
